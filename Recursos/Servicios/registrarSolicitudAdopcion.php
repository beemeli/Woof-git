<?php
   ...
   if(isset($_POST['experiencia']) && isset($_POST['personalidad']) && isset($_POST['tamano']) ){
	...
	$tamano = $_POST['tamano'];
        ...
        $resultado = $admin->altaSolicitud($usuario,$fecha,$estatus,$observaciones,$experiencia,$tamano, $personalidad);
