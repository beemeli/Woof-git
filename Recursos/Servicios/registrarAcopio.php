<?php
   ...
   if(isset($_POST['nombre']) && isset($_POST['responsable']) && isset($_POST['telefono']) && isset($_POST['latitud']) && isset($_POST['longitud'])){
    ...
    $longitud = $_POST['longitud'];
        ...
        $resultado = $admin->altaAcopio($nombre, $responsable, $telefono, $latitud, $longitud);
