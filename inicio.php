...
<html>
    <head>
        ...
        <script type="text/javascript" src="js/controllerConsultarPerritos.js"></script>
    </head>
    <body>
...
?>
        ...
        <div class ="container">
        <br/><br/>
                         <img id="mini" class="botonPerrito" src="images/mini.png" style="width: 80px;"/>
                <img id="pequeno" class="botonPerrito" src="images/chico.png" style="width: 100px;"/>
                <img id="mediano" class="botonPerrito" src="images/mediano.png" style="width: 120px;"/>
                <img id="grande" class="botonPerrito" src="images/grande.png" style="width: 140px;"/>
                ...
                <div id="divRespuestaPerrito">
                    ...
                    <div id="pesoP"></div>
                    <div class="botonAdoptar">¡Regístrate para adoptarme!</div>
