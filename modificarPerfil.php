...
-->
    ...
    <body>
        ...
        <div class="main">
            ...
            <button id="modificarPerfil" class="btn waves-effect waves-light  blue lighten-3 botonEnviar">Enviar
...
<!--antiguo codigo -->
        ...
        <form>
        <input type="password" id="password" placeholder="Contraseña actual" />
        <br/>
        <br/>
        <input type="password" id="password1" placeholder="Nueva Contraseña" />
        <br/>
        <br/>
        <input type="password" id="password2" placeholder="Nueva Contraseña" />
        <br/>
        <br/>
        <input type="tetx" id="correo" placeholder="Correo" />
        <br/>
        <br/>
        </form>
